...
class _017_Frame_Buffer_Struct_Multi_Samples
{
    ...
    private unsafe void OnRender(double deltaTime) //Method needs to be unsafe due to draw elements.
    {
        ...
        BlitFramebufferToScreen(Gl, _multiSampledFrameBuffer.Fbo, (int)_multiSampledFrameBuffer.Width, (int)_multiSampledFrameBuffer.Height);
    }
    ...
    void BindFramebuffer(FrameBuffer frameBuffer, bool bindViewport)
    {
        GL.BindFramebuffer(FramebufferTarget.Framebuffer, frameBuffer.Fbo);
