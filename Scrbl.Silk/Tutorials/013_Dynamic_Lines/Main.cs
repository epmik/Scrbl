...
class _013_Dynamic_Lines
{
    ...
    public void Run(string[] args)
    {
        ...
        options.Title = "_013_Dynamic_Lines";
        options.VSync = false;
    ...
    private unsafe void OnLoad()
    {
        ...
        //chunk.Transform.Position = new Vector3(0.75f, 0f, 0f);
        ...
        //chunk.Transform.Position = new Vector3(-0.25f, 0f, 0f);
        ...
        //chunk.Transform.Position = new Vector3(0.0f, 0.25f, 0f);
